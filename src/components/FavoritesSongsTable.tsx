...
export default function FavoritesSongsTable({ tracks }: { tracks: Track[] }) {
  return (
        ...
        <tbody>
          {tracks.map((track) => (
            ...
            >
              ...
              <td className="px-4 py-3 text-slate-400">{track.genre}</td>
              <td className="px-4 py-3 text-slate-400">{track.releaseDate}</td>
              <td className="px-4 py-3">{track.popularity}</td>
              <td className="px-4 py-3">{track.duration}</td>
              <td className="px-4 py-3">{track.explicit ? "🔞" : "—"}</td>
            </tr>
          ))}
        </tbody>
      </table>
